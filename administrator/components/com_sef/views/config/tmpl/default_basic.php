...
echo JHtml::_('tabs.panel', JText::_('COM_SEF_BASIC'), 'basic');
  ...
  <fieldset class="adminform">
      ...
      <table class="adminform table table-striped">
        ...
        <tr<?php $x++; echo (($x % 2) ? '':' class="row1"' );?>>
            <td><?php echo $this->tooltip(JText::_('COM_SEF_TT_FORCE_SSL'),JText::_('COM_SEF_FORCE_SSL'));?></td>
            <td><?php echo JText::_('COM_SEF_FORCE_SSL');?>?</td>
            <td><?php echo $this->lists['forceSsl'];?></td>
        </tr>
        <tr<?php $x++; echo (($x % 2) ? '':' class="row1"' );?>>
