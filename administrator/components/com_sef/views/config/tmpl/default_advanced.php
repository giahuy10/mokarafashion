          ...
          <div class="fltlft" style="width: 50%">
    		  <fieldset class="adminform">
    		      ...
    		      <table class="adminform table table-striped">
        	        ...
        	        <tr<?php $x++; echo (($x % 2) ? '':' class="row1"' );?>>
        	            <td><?php echo $this->tooltip(JText::_('COM_SEF_TT_HOME_PAGE_HITS'), JText::_('COM_SEF_HOME_PAGE_HITS'));?></td>
        	            <td><?php echo JText::_('COM_SEF_HOME_PAGE_HITS');?>:</td>
        	            <td><?php echo $this->lists['homePageHits']; ?></td>
        	        </tr>
        	        <tr<?php $x++; echo (($x % 2) ? '':' class="row1"' );?>>
        	            <td><?php echo $this->tooltip(JText::_('COM_SEF_TT_CHUNKED_EXPORT'), JText::_('COM_SEF_CHUNKED_EXPORT'));?></td>
        	            <td><?php echo JText::_('COM_SEF_CHUNKED_EXPORT');?>:</td>
        	            <td><?php echo $this->lists['chunkedExport']; ?></td>
        	        </tr>
        	        </table>
    		    </fieldset>
            ...
            <div class="fltlft" style="width: 50%">
                ...
                <fieldset class="adminform">
                    ...
                    <table class="adminform table table-striped">
            	        ...
            	        <tr<?php $x++; echo (($x % 2) ? '':' class="row1"' );?>>
            	            <td><?php echo $this->tooltip(JText::_('COM_SEF_TT_ALWAYS_ADD_ITEMID'), JText::_('COM_SEF_ALWAYS_ADD_ITEMID'));?></td>
            	            <td><?php echo JText::_('COM_SEF_ALWAYS_ADD_ITEMID');?></td>
            	            <td><?php echo $this->lists['alwaysAddItemid'];?></td>
            	        </tr>
                    </table>
                </fieldset>
            </div>
