...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_inventory&task=sales.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'saleList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="saleList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_SALES_CREATED', 'a.`created`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_SALES_TOTAL', 'a.`total`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_SALES_STATUS', 'a.`status`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'sales.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
