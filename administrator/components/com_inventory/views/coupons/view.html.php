 ...
 * @since  1.6
 */
class InventoryViewCoupons extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		InventoryHelper::addSubmenu('coupons');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_INVENTORY_TITLE_COUPONS'), 'coupons.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_inventory&view=coupons');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`coupon_code`' => JText::_('COM_INVENTORY_COUPONS_COUPON_CODE'),
			'a.`coupon_type`' => JText::_('COM_INVENTORY_COUPONS_COUPON_TYPE'),
			'a.`coupon_value`' => JText::_('COM_INVENTORY_COUPONS_COUPON_VALUE'),
		);
	}
