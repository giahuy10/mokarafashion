...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_inventory&task=coupons.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_inventory&view=coupons'); ?>" method="post"
			...
			<table class="table table-striped" id="couponList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_COUPONS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_COUPONS_COUPON_CODE', 'a.`coupon_code`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_COUPONS_COUPON_TYPE', 'a.`coupon_type`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_INVENTORY_COUPONS_COUPON_VALUE', 'a.`coupon_value`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'coupons.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_inventory&task=coupon.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->coupon_code); ?></a>
				<?php else : ?>
