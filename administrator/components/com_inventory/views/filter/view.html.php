 ...
 * @since  1.6
 */
class InventoryViewFilter extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_INVENTORY_TITLE_FILTER'), 'filter.png');
		...
		{
			JToolBarHelper::custom('filter.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		}

		// Button for version control
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_inventory.filter', $this->item->id);
		}
