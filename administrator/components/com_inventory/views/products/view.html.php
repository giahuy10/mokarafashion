 ...
 * @since  1.6
 */
class InventoryViewProducts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		InventoryHelper::addSubmenu('products');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_INVENTORY_TITLE_PRODUCTS'), 'products.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_inventory&view=products');
	}
