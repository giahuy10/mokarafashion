 ...
 * @since  1.6
 */
class InventoryViewCoupon extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_INVENTORY_TITLE_COUPON'), 'coupon.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_inventory.coupon', $this->item->id);
		}
