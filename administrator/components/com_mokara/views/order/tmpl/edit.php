...
$document->addStyleSheet(JUri::root() . 'media/com_mokara/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_mokara&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="order-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_MOKARA_TITLE_ORDER', true)); ?>
		<div class="row-fluid">
		...
		<?php if (JFactory::getUser()->authorise('core.admin','mokara')) : ?>
