...
if(!function_exists("show_product_item")) {
	...
	<div class="ed-inner-product">
		...
		<div class="ed-item-img">
			<a href="<?php echo $link?>"><img src="images/san-pham/<?php echo $img_link?>" alt="<?php echo $item->title?>"/></a>
		</div>
		...
		<?php echo $item->introtext; ?>
			<div class="ed-price-block">
				...
				<form action="<?php echo JRoute::_('index.php?option=com_mokara&view=orders&Itemid=502')?>" method="post" class="pull-left">
