...
class Plgwbampcontent extends JPlugin
{
	...
	/**
	 * Finds out whether current request is for a single page, or something else
	 *
	 ...
	 * @return bool
	 */
	public function onWbampIsSingular(& $isSingular, $request)
	{
