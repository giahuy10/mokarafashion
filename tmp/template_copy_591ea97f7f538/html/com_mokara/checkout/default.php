...
<form action="<?php echo JRoute::_('index.php?option=com_mokara&view=checkout'); ?>" method="post"
	...
	<table class="table">
		...
		<tr>
			...
			<td><input class="form-control" type="text" name="address" value="<?php echo $user->name?>" required/></td>
		</tr>
		<tr>
			<td><strong>Điện thoại</strong></td>
			<td><input class="form-control" type="text" name="phone" value="<?php echo $user->name?>" required/></td>
		</tr>
		<tr>
